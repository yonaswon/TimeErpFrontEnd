...
interface AdminInvoiceTransferProps {
  onClose: () => void
  onBack: () => void
}

export const AdminInvoiceTransfer = ({ onClose, onBack }: AdminInvoiceTransferProps) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Fixed values for admin invoice transfer from wallet 1 to wallet 2
    ...
    return (
      <div className="text-center py-6">
        ...
        <div className="text-sm text-green-700 dark:text-green-300">
          Invoice transfer to finance has been processed successfully.
        </div>
      </div>
    )
  }
    ...
    <div className="space-y-4">
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-3">
        <div className="text-sm text-blue-700 dark:text-blue-300">
          <strong>Transfer Details:</strong> From Admin Wallet (ID: 1) to Finance Wallet (ID: 2) - Invoice Funds
        </div>
      </div>
      ...
      <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
        <AdminAccountDropdown
          ...
          disabled={submitting}
          required
          invoice={true} // CURRENT accounts for invoice
        />
