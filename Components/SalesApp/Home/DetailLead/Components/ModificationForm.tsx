...
import api from '@/api'
import { Upload, Image as ImageIcon, X, FileText, DollarSign, Info } from 'lucide-react'
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm">
            <div className="font-medium text-blue-800 dark:text-blue-300 mb-1">Modification Details</div>
            <div className="text-blue-700 dark:text-blue-400 space-y-1">
              <div>• Lead: #{leadId}</div>
              <div>• Mockup: #{mockupId}</div>
      ...
      <div className="flex items-center">
        <input
          ...
          name="price_with_vat"
          type="checkbox"
          checked={formData.price_with_vat}
          onChange={handleInputChange}
          className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
        />
        <label htmlFor="price_with_vat" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
          Include VAT in pricing
        </label>
      </div>
