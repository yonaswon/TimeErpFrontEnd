...
interface NonInvoiceTransferProps {
  onClose: () => void
  onBack: () => void
}

export const NonInvoiceTransfer = ({ onClose, onBack }: NonInvoiceTransferProps) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Fixed values for non-invoice transfer from wallet 2 to wallet 1
    ...
    return (
      <div className="text-center py-6">
        ...
        <div className="text-sm text-green-700 dark:text-green-300">
          Non-invoice transfer has been processed successfully.
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-3">
        <div className="text-sm text-green-700 dark:text-green-300">
          <strong>Transfer Details:</strong> From Finance Wallet (ID: 2) to Admin Wallet (ID: 1) - Non-Invoice Funds
        </div>
      </div>
      ...
      <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
        <AccountDropdown
          ...
          disabled={submitting}
          required
          invoice={false} // Pass invoice=false for PERSONAL accounts
        />
        ...
        <div>
          ...
          <div className="border-2 border-dashed border-gray-300 dark:border-zinc-600 rounded-lg p-4 text-center">
            ...
            <input
              ...
              disabled={submitting}
              className="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-medium file:bg-green-50 file:text-green-700 hover:file:bg-green-100 dark:file:bg-green-900/20 dark:file:text-green-300"
            />
