...
import { ShoppingCart, Wrench, TrendingUp, Search, Filter, RefreshCw, Loader, Package } from 'lucide-react'
...
const OrdersContent = () => {
  ...
  const tabs = [
    ...
    { id: 'product-sales' as OrdersTabType, label: 'Product Sales', icon: TrendingUp },
  ]
  ...
  const handleSearchSubmit = () => {
    ...
    const searchUrl = `/api/order-container/?ordering=-created_at&search=${encodeURIComponent(searchQuery)}`
  ...
  const filteredOrders = orders.filter(order =>
    ...
    order.orders?.some((o: any) => o.order_name?.toLowerCase().includes(searchQuery.toLowerCase()))
  )
          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`flex items-center space-x-2 px-4 py-3 min-w-max flex-1 justify-center border-b-2 transition-colors duration-200 ${isActive
      ...
      <div className="w-full p-4">
          ...
          <div className="w-full">
            ...
            {loadingMore && (
              <div className="flex justify-center items-center py-4">
                ...
                <span className="text-gray-500 dark:text-gray-400">Loading more orders...</span>
              </div>
            )}
            ...
            {orders.length === 0 && !loading && !error && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-400 dark:text-gray-500 text-sm">
                  {searchQuery ? 'Try adjusting your search terms' : 'There are no orders to display'}
                </p>
              </div>
            )}
        ...
        {activeTab === 'maintenance' && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 dark:text-gray-400">Maintenance tab coming soon...</p>
          </div>
        )}
        ...
        {activeTab === 'product-sales' && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 dark:text-gray-400">Product Sales tab coming soon...</p>
          </div>
        )}
      </div>
