...
const SubmitMockupOverlay = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/40 dark:bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-zinc-900 rounded-2xl w-full max-w-lg shadow-2xl transition-all max-h-[90vh] flex flex-col">
        {/* Header */}
              ...
              {mockupImagePreview ? (
                <div className="space-y-3">
                  <img
                    ...
                    alt="Mockup preview"
                    className="max-h-48 w-auto mx-auto rounded-lg shadow-md object-contain"
                  />
                  <button
                    onClick={() => {
                      setMockupImage(null);
        ...
        <div className="p-6 md:p-8 border-t border-gray-200 dark:border-zinc-800">
