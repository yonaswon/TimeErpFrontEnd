          ...
          <Section title="Material Information">
            <div className="bg-[#FFFFFF] dark:bg-[#1E293B] border border-[#E5E7EB] dark:border-[#334155] rounded-[12px] p-[16px]">
              {(() => {
                ...
                if (mat.kind === 'outside') {
                  return (
                    <>
                      ...
                      {file.old_material_number ? (
                        <InfoRow label="Note" value={file.old_material_number} />
                      ) : null}
                      <InfoRow label="Source" value={
                        <span className="px-2 py-1 rounded-[8px] text-[14px] font-medium bg-teal-100 dark:bg-teal-900/30 text-teal-700 dark:text-teal-300">
                          Outside (client material)
                        </span>
                      } isLast={true} />
                    </>
                  );
                ...
                return <InfoRow label="Material" value="Unknown Material" isLast={true} />;
              })()}
            </div>
          </Section>
