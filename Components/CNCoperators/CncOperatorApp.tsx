...
const CncProfileContent = ({ user, userData, selectedRole, onRoleSelect }: any) => {
  return (
      ...
      {user ? (
        <>
          ...
          <div className="mt-4 p-4 bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 max-w-sm">
            <h3 className="font-medium text-gray-900 dark:text-white mb-2">CNC Operator</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Operate CNC machines, manage cutting tasks, and ensure quality production.
            </p>
          </div>
        </>
      ) : (
      ...
      <div className="bg-white dark:bg-zinc-800 rounded-lg p-4 border border-gray-200 dark:border-zinc-700 max-w-sm w-full">
        ...
        <div className="grid grid-cols-3 gap-2 text-center">
          ...
          <div className="p-2 bg-blue-50 dark:bg-blue-900/20 rounded">
            ...
            <div className="text-xs text-blue-700 dark:text-blue-300">Quality</div>
          </div>
          <div className="p-2 bg-purple-50 dark:bg-purple-900/20 rounded">
            <div className="text-lg font-bold text-purple-600 dark:text-purple-400">2</div>
            <div className="text-xs text-purple-700 dark:text-purple-300">Issues</div>
          </div>
        </div>
      </div>
