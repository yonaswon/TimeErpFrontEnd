...
import { Scissors, Wrench, Truck, Clock } from 'lucide-react';
...
export const TasksContent = () => {
  const [activeOverlay, setActiveOverlay] = useState<'cutting' | 'assembly' | 'delivery' | null>(null);

  return (
    <div className="space-y-6">
      {/* Assignment Buttons */}
      <div className="bg-white dark:bg-zinc-800 rounded-lg p-4 border border-gray-200 dark:border-zinc-700 shadow-sm">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Assign Tasks</h2>
        ...
        <div className="grid grid-cols-1 gap-3">
          ...
          >
            ...
            <div className="text-left">
              <div className="font-medium text-blue-600 dark:text-blue-400">Assign Cutting</div>
              <div className="text-sm text-blue-500 dark:text-blue-300">Assign CNC cutting tasks to operators</div>
            </div>
          </button>
          ...
          >
            ...
            <div className="text-left">
              <div className="font-medium text-green-600 dark:text-green-400">Assign Assembly</div>
              <div className="text-sm text-green-500 dark:text-green-300">Assign assembly tasks to team members</div>
            </div>
          </button>
          ...
          >
            ...
            <div className="text-left">
              <div className="font-medium text-purple-600 dark:text-purple-400">Assign Delivery & Installation</div>
              <div className="text-sm text-purple-500 dark:text-purple-300">Schedule delivery and installation tasks</div>
            </div>
          </button>
        </div>
      </div>
      ...
      {activeOverlay === 'assembly' &&  <AssignAssemblyOverlay
    ...
    />}
      ...
      {activeOverlay === 'delivery' && <DandIOverlay 
    onClose={() => setActiveOverlay(null)}
    onSuccess={() => {
      setActiveOverlay(null);
      // Refresh any data if needed
