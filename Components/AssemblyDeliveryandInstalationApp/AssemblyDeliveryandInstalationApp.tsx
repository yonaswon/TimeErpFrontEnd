...
type TabType = 'overview' | 'assembly' | 'delivery-installation' | 'stock' | 'profile'

const AssemblyDeliveryandInstalationApp = ({ userData, selectedRole, onRoleSelect }: any) => {
  ...
  const tabs = [
    ...
    { id: 'delivery-installation' as TabType, label: 'Delivery & Install', icon: Truck },
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'stock':
        return <div className="bg-white dark:bg-zinc-800 rounded-lg p-8 border border-gray-200 dark:border-zinc-700 text-center">
          <Package className="w-16 h-16 text-gray-400 mx-auto mb-4" />
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Stock Management</h3>
          <p className="text-gray-600 dark:text-gray-400">Stock management features will appear here</p>
        </div>
      case 'profile':
        return <AssemblyProfileContent 
          user={user} 
          userData={userData} 
...
const AssemblyOverviewContent = () => (
  <div className="space-y-4">
    ...
    <div className="bg-white dark:bg-zinc-800 rounded-lg p-4 border border-gray-200 dark:border-zinc-700 shadow-sm">
      <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Today's Operations</h2>
      
      <div className="grid grid-cols-2 gap-4 text-center">
        <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
          <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">6</div>
          <div className="text-xs text-blue-700 dark:text-blue-300">Assembly Tasks</div>
        </div>
        <div className="p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
          <div className="text-2xl font-bold text-green-600 dark:text-green-400">4</div>
          <div className="text-xs text-green-700 dark:text-green-300">Deliveries</div>
        </div>
        <div className="p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
          <div className="text-2xl font-bold text-yellow-600 dark:text-yellow-400">3</div>
          <div className="text-xs text-yellow-700 dark:text-yellow-300">Installations</div>
        </div>
        <div className="p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
          <div className="text-2xl font-bold text-purple-600 dark:text-purple-400">8</div>
          <div className="text-xs text-purple-700 dark:text-purple-300">In Stock</div>
        </div>
      </div>
    </div>
    ...
    {/* Team Schedule */}
    <div className="bg-white dark:bg-zinc-800 rounded-lg p-4 border border-gray-200 dark:border-zinc-700 shadow-sm">
      <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Today's Schedule</h2>
      ...
      <div className="space-y-3">
        <div className="flex justify-between items-center p-3 bg-gray-50 dark:bg-zinc-700 rounded-lg">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="text-sm font-medium text-gray-900 dark:text-white">Morning Assembly</div>
              <div className="text-xs text-gray-500 dark:text-gray-400">Office Furniture Sets</div>
            </div>
          </div>
          <div className="text-right">
            <div className="text-sm font-medium text-green-600 dark:text-green-400">08:00 AM</div>
            <div className="text-xs text-gray-500 dark:text-gray-400">4 items</div>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center p-3 bg-gray-50 dark:bg-zinc-700 rounded-lg">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="text-sm font-medium text-gray-900 dark:text-white">Delivery Run #1</div>
              <div className="text-xs text-gray-500 dark:text-gray-400">Downtown Area</div>
            </div>
          </div>
          <div className="text-right">
            <div className="text-sm font-medium text-blue-600 dark:text-blue-400">10:30 AM</div>
            <div className="text-xs text-gray-500 dark:text-gray-400">3 stops</div>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center p-3 bg-gray-50 dark:bg-zinc-700 rounded-lg">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="text-sm font-medium text-gray-900 dark:text-white">Installation Team</div>
              <div className="text-xs text-gray-500 dark:text-gray-400">Commercial Client</div>
            </div>
          </div>
          <div className="text-right">
            <div className="text-sm font-medium text-yellow-600 dark:text-yellow-400">02:00 PM</div>
            <div className="text-xs text-gray-500 dark:text-gray-400">2 members</div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div className="space-y-3">
        <div>
          <div className="flex justify-between text-sm mb-1">
            <span className="text-gray-600 dark:text-gray-400">Office Chairs</span>
            <span className="font-medium text-green-600 dark:text-green-400">75%</span>
          </div>
          <div className="w-full bg-gray-200 dark:bg-zinc-700 rounded-full h-2">
            <div className="bg-green-600 h-2 rounded-full" style={{ width: '75%' }}></div>
          </div>
          <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">45 units available</div>
        </div>
        
        <div>
          <div className="flex justify-between text-sm mb-1">
            <span className="text-gray-600 dark:text-gray-400">Desks</span>
            <span className="font-medium text-yellow-600 dark:text-yellow-400">40%</span>
          </div>
          <div className="w-full bg-gray-200 dark:bg-zinc-700 rounded-full h-2">
            <div className="bg-yellow-600 h-2 rounded-full" style={{ width: '40%' }}></div>
          </div>
          <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">20 units available</div>
        </div>
        
        <div>
          <div className="flex justify-between text-sm mb-1">
            <span className="text-gray-600 dark:text-gray-400">Storage Cabinets</span>
            <span className="font-medium text-red-600 dark:text-red-400">15%</span>
          </div>
          <div className="w-full bg-gray-200 dark:bg-zinc-700 rounded-full h-2">
            <div className="bg-red-600 h-2 rounded-full" style={{ width: '15%' }}></div>
          </div>
          <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">8 units available - Reorder needed</div>
        </div>
      </div>
    </div>
...
const AssemblyProfileContent = ({ user, userData, selectedRole, onRoleSelect }: any) => {
  return (
      ...
      {user ? (
        <>
          ...
          <div className="mt-4 p-4 bg-white dark:bg-zinc-800 rounded-lg border border-gray-200 dark:border-zinc-700 max-w-sm">
            <h3 className="font-medium text-gray-900 dark:text-white mb-2">Assembly & Installation Specialist</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Manage assembly tasks, handle deliveries, installations, and stock management operations.
            </p>
          </div>
        </>
      ) : (
      ...
      <div className="bg-white dark:bg-zinc-800 rounded-lg p-4 border border-gray-200 dark:border-zinc-700 max-w-sm w-full">
        ...
        <div className="grid grid-cols-2 gap-2 text-center">
          <div className="p-2 bg-green-50 dark:bg-green-900/20 rounded">
            ...
            <div className="text-xs text-green-700 dark:text-green-300">Assembled</div>
          </div>
          <div className="p-2 bg-blue-50 dark:bg-blue-900/20 rounded">
            <div className="text-lg font-bold text-blue-600 dark:text-blue-400">12</div>
            <div className="text-xs text-blue-700 dark:text-blue-300">Deliveries</div>
          </div>
          ...
          <div className="p-2 bg-purple-50 dark:bg-purple-900/20 rounded">
            ...
            <div className="text-xs text-purple-700 dark:text-purple-300">Satisfaction</div>
          </div>
        </div>
      </div>
