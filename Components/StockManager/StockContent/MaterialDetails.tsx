...
export const MaterialDetails = ({
  ...
  // Helper function to render inventory distribution based on material type
  const renderInventoryDistribution = () => {
    ...
    // Areal materials (array format)
    if (Array.isArray(distribution)) {
      return (
        <div className="space-y-3">
          {distribution.map((inventory, index) => (
            <div
              key={index}
            ...
            >
              <div>
                ...
                <div className="text-sm text-gray-500 dark:text-gray-400">
                  Total: {inventory.total} • Unstarted: {inventory.unstarted} •
                  Started: {inventory.started}
                </div>
              </div>
              <div
    ...
    // Length materials (object format)
  ...
  // Helper function to render statistics based on material type
  const renderStatistics = () => {
    const stats = material?.stats;

    if (material.type === "A") {
      // Areal material stats
      return (
